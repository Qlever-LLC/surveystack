<template>
  <div class="full">
    <a-card theme="dark" color="dark-blue-lighten-2" class="card-height" v-slot:panel>
      <a-card-title
        >{{ title || '' }}
        ...
        <a-btn class="mr-2" variant="outlined" color="white" v-if="runnable" @click="$emit('run', model.getValue())">
