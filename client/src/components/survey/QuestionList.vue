<template>
  <a-list two-line v-model:selected="selected" :select-strategy="singleLeaf">
    <a-list-item v-for="(question, index) in questions" :key="question.number" active-class="text-pink">
