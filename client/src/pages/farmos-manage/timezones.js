...
export const timezones = {
  countries: {
    ...
    MY: {
      name: 'Malaysia',
      abbr: 'MY',
      zones: ['Asia/Kuala_Lumpur', 'Asia/Kuching', 'Asia/Singapore'],
    },
    MZ: {
      name: 'Mozambique',
      abbr: 'MZ',
    ...
    UA: {
      name: 'Ukraine',
      abbr: 'UA',
      zones: ['Europe/Simferopol', 'Europe/Kiev', 'Europe/Uzhgorod', 'Europe/Zaporozhye'],
    },
    UG: {
      name: 'Uganda',
      abbr: 'UG',
    ...
    UM: {
      ...
      abbr: 'UM',
      zones: ['Pacific/Pago_Pago', 'Pacific/Wake', 'Pacific/Honolulu', 'Pacific/Midway'],
    },
    US: {
      name: 'United States',
      abbr: 'US',
